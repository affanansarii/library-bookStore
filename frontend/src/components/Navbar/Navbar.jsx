            ...
            >
                ...
                {isLoggedIn === false && (
                    <>
                        <Link
                            to="/signin"
                            className={`${MobileNav} px-8 mb-8 text-3xl font-semibold py-2 border border-blue-500 text-white rounded hover:bg-white hover:text-zinc-800 transition-all duration-300`}
                        >
                            SignIn
                        </Link>
                        <Link
